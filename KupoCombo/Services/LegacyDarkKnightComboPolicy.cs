...
internal sealed class LegacyDarkKnightComboPolicy : ITrainingPolicy
{
    ...
    public string Id => "drk-priority-practice-legacy";

    public string Name => "DRK Legacy Priority Practice";
